...
while(1):
	...
	for i in range(0, len(points) - 1):
		cv2.arrowedLine(img, (points[i][0] + 200, points[i][1]), (points[i+1][0] + 200, points[i+1][1]), (150 - color, 255, 100 - color/4), 2, tipLength = 0.05)
		if color == 0:
			color = 120
		else: color = 0
	...
	for i in range(0, len(points)-1):
		...
		cv2.arrowedLine(img, (points[i+1][0] + 200, points[i+1][1]), (velPoint[0], velPoint[1]), (100, 150 - color, 255), 3, tipLength = 0.08)
